...
class SignInPage extends BaseView<SignInViewModel> {
   SignInPage({super.key}) :super(
     vmFactory: (context) => SignInViewModel(context)
   );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("AnimeHubChat",style: Theme.of(vm.context).textTheme.displayMedium),
            const SizedBox(height: 18,),
            EmailTextFieldWidget(controller: vm.emailTextCtrl,),
            const SizedBox(height: 16,),
            PasswordTextFieldWidget( passTextEditingController: vm.passwordTextCtrl, labelText: 'Пароль',),
            const SizedBox(height: 20,),
            vm.isButtonActive.observer((context, value) =>
                CustomFilledButton(isButtonActive: value, titleButton: "Войти", buttonCallback: () async { }),
            ),
             const SizedBox(height: 16,),
             Row(
              ...
              children: [
               ...
               Text("или",style: Theme.of(vm.context).textTheme.headlineSmall,),
                _customDelimiter(maxWidth: maxWidth),
                ...
                text: TextSpan(
                  children: [
                    TextSpan(
                      ...
                      style: Theme.of(vm.context).textTheme.bodyLarge?.apply(
                    ...
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          AutoRouter.of(vm.context).push( RegistrationRoute());
                        },
                    ),
                  ],
                ),
