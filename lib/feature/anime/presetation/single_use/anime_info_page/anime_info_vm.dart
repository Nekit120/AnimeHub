...
class AnimeInfoViewModel extends ViewModel {
  ...
  AnimeInfoViewModel(super.context,
      ...
      : insertAnimeItemInUseCase =
            InsertAnimeItemInFavoritesUseCase(animeRepository: animeRepository),
        updateAnimeListFromDbUseCase =
            UpdateAnimeListFromDbUseCase(animeRepository: animeRepository),
        checkIfAnimeIsFavoriteUseCase =
            CheckIfAnimeIsFavoriteUseCase(animeRepository: animeRepository),
        deleteAnimeFromFavoriteUseCase =
            DeleteAnimeFromFavoriteUseCase(animeRepository: animeRepository);
