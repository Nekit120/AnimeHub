...
class SendAnimeListBuilderWidget extends StatelessWidget {
  ...
  const SendAnimeListBuilderWidget({super.key,
    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          ...
          onTap: () {
            chatAndAuthRepository.sendInvite(animeLink: animeList[index].link,
                animeName: animeList[index].title,
                animePoster: animeList[index].materialData!.posterUrl!,
                proposedId: proposedId,
                acceptId: acceptId);
            AutoRouter.of(context).replace(PersonalChatRoute(receiverUsername: receiverUsername, chatAndAuthRepository: chatAndAuthRepository, receiverId: receiverId, userModel: userModel));
          },
        );
      },
    );
