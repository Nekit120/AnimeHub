...
part of 'anime_remote_data_source.dart';
...
class _AnimeRemoteDataSource implements AnimeRemoteDataSource {
  _AnimeRemoteDataSource(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<AnimeApiList> getAnimeList(
      {GetAnimeListQuery query = const GetAnimeListQuery()}) async {
